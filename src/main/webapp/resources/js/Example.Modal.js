...
Example.Modal.prototype = {
    ...
    show : function() {
        ...
        // 콘텐츠 레이어 보여주기
        $("#"+this.hash.id).fadeIn("slow");; 
 
        // 배경 레이어 보여주기
        $("#"+this.hash.id+"_overlay").fadeIn("slow");;
    },
 
    // 모달창 감추기
    hide : function() {
        $("#"+this.hash.id).fadeOut("slow");; // 콘텐츠 레이어 감추기
        $("#"+this.hash.id+"_overlay").fadeOut("slow"); // 배경 레이어 감추기
    },  
    ...
    addOverlay : function() {
        var html = "";
        html += "<div id='"+this.hash.id+"_overlay' style='display:none;width:100%;position:absolute;top:0px;left:0px;opacity:0.7;background-color:#000000;z-Index:999'></div>";
