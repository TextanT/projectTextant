...
<body>
    <div class="header">
        <div class="header_logo" style="padding-top: 20px;">
            <a href="/textant/main.text" class="logo_a"> <img src="/textant/resources/icon_img/logo_mini.png" class="logo">
            </a>
        </div>
        <div class="menu_box">
            <c:if test="${id!=null}">
    ...
    <div class="find_pos">
        <div class="idfind">
            <h3>아이디찾기</h3>
            <input type="text" class="findidName"><br>
            <input type="text" class="findidEmail">
            <a href="#" class="idFinding">아이디찾기</a>
        </div>
        <div class="passfind">
            <h3>비밀번호찾기</h3>
            <input type="text" class="findpassName"><br>
            <input type="text" class="findpassId">
