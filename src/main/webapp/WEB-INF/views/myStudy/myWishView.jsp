...
<body>
	...
	<div class="serchpos">
		...
		<div class="serchbookDiv">
			<c:forEach var="wisht" items="${wishtList}">
				<div class="genre1_book_list" onmouseenter="bookCapOn(${wisht.wishNum})" onmouseleave="bookCapOff(${wisht.wishNum})">
					<a name="bookArticleNum" href="/textant/myWishDelete.text?pageNum=${pageNum}&wishNum=${wisht.wishNum}">삭제</a><br>
					<a href="/textant/read.text?fileName=${wisht.fileLocation}">
						<img src="displayFile.text?fileName=${wisht.fileLocation}/OriginImg&pageNum=1&fileType=jpg" style="border: 1px solid #D8D8D8; width: 166.45px; height: 244px; position: absolute; z-index: 2; height: 242px;" class="book_img_size" id="bookimg" >
							
							<div style="width: 166.45px; height: 244px; position: relative; text-align: center; color: white; background: gray;z-index: 1; background-color: rgba(0, 0, 0, 0.5);" class="book_cap${wisht.wishNum}" id="book_cap${wisht.wishNum}">
