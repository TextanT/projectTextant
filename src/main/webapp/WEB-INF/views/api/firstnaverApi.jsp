...
<title>TEXTANT</title> <script type="text/javascript" src="https://static.nid.naver.com/js/naverLogin_implicit-1.0.3.js" charset="utf-8"></script>
...
<!--   <div id="naver_id_login"></div>  -->
  ...
  <script type="text/javascript">
  	...
  	naver_id_login.setDomain("http://localhost:800/textant/naverlogin.text");
