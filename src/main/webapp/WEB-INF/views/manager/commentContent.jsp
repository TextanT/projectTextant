...
<body>
	...
	<div id="managingDistrict">
		<div style="margin-top: 50px;">
			<h3 style="text-align: center">댓글 상세</h3>
		</div>
		<div
			...
			<div class="managing" id="recommendBook">
				...
				<table class="table table-bordered"
					...
					<tr>
						<td>작성날짜</td>
						<td colspan="3"><c:out value="${commentsList.writeDate}" /></td>
					</tr>
					<tr>
						<td>좋아요</td>
						<td><c:out
								value="${commentsList.commentGood}" /></td>
								<td>싫어요</td><td><c:out
								value="${commentsList.commentBad}" /></td>
					</tr>
					<tr>
						<td colspan="4">내용</td>
					</tr>
					<tr>
						<td colspan="4" style="text-align: left;"><textarea
								...
								style="background-color: white;"><c:out value="${commentsList.conet}"/></textarea></td>
					</tr>
					<tr>
							<td colspan="4">
	...
	<script type="text/javascript">
		...
		function delete_event() {
			if (confirm("정말 삭제하시겠습니까??") == true) { //확인
				document.location.href = 'commentDelete.text?commentNum=${commentsList.commentNum}&referer=${referer}';
				setTimeout(function() {
				history.back();
					}, 500);
			} else { //취소
