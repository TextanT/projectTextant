				...
				<table class="table table-bordered"
					...
					<tr>
						...
						<td colspan="3" style="text-align: left;"><textarea
								...
								style="resize: none; background-color: white;"><c:out value="${managingList.reportComment}"/></textarea></td>
					</tr>
					<tr>
						<td>댓글 내용</td>
						<td colspan="3" style="text-align: left;"><textarea
								readonly="readonly" class="form-control" rows="10"
								style="resize: none; background-color: white;"><c:out value="${managingList.comment}"/></textarea></td>
					</tr>
					<tr>
	...
	<script type="text/javascript">
		...
		function delete_event() {
			if (confirm("정말 삭제하시겠습니까??") == true) { //확인
				document.location.href = 'reportCommentDelete.text?reportCommentNum=${managingList.num}';
			} else { //취소
				return;
			}
		}
